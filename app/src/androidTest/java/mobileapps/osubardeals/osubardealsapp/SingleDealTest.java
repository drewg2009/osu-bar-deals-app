...
public class SingleDealTest {
    ...
    @Test
    public void testBigBarDealFromDealList() {
        ...
        solo.clickOnText("Deals");
        solo.waitForView(solo.getView(R.id.my_recycler_view));
        //From bars page click big bar - assumes it works
        solo.clickOnText("The Big Bar");
        solo.waitForView(solo.getView(R.id.dealLocation));

        //Check that Big Bar's page was loaded
        Assert.assertTrue(solo.getText(7).getText().toString().equals("The Big Bar"));
