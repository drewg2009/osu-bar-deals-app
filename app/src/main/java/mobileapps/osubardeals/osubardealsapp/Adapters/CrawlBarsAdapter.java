...
public class CrawlBarsAdapter extends RecyclerView.Adapter<CrawlBarsAdapter.ViewHolder> {
...
private Context c;
    ...
    public CrawlBarsAdapter(List<JSONObject> myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public CrawlBarsAdapter.ViewHolder onCreateViewHolder(final ViewGroup parent,
                                                          int viewType) {
        ...
        barCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                barBundle.putString("order", nameTextView.getText().toString());
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        try {
            holder.nameTextView.setText(mDataset.get(position).getString("order"));
